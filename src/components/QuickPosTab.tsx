...
export default function QuickPosTab() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-[calc(100vh-64px)] overflow-hidden" id="quick-pos-container">
      ...
      {showReceiptModal && lastInvoiceReceipt && (
        <div className="fixed inset-0 bg-slate-900/60 z-50 flex items-center justify-center p-4" id="receipt-modal-backdrop">
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden border border-slate-200 shadow-xl" id="receipt-modal-content">
            {/* سربرگ کاغذ حرارتی فاکتور */}
            <div className="bg-slate-50 border-b border-dashed border-slate-200 p-5 text-center relative" id="receipt-paper-header">
              <span className="text-[10px] bg-emerald-50 text-emerald-600 px-2 py-0.5 rounded-full font-bold">فروش سریع موفق</span>
              <h2 className="font-bold text-xs text-slate-800 mt-2">رسید چاپی صندوق فروشگاه آریا</h2>
            ...
            <div className="p-3 bg-slate-50 border-t border-slate-100 flex gap-2">
              <button
                ...
                onClick={() => { alert('پیش‌نمایش پرینتر حرارتی ۸۰ میلی‌متری ویندوز صادر شد. اتصال با درایور مستقیم برقرار است.'); }}
                className="flex-1 py-1.5 rounded-lg bg-emerald-600 text-white font-bold text-xs flex items-center justify-center gap-1.5"
              >
